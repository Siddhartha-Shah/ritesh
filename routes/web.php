...
Route::post("/customer/cancel_request/{id}",[ServiceController::class,"customer_cancel_request"]);
...
Route::get("/ompleteBookingAction/{id}",[ServiceController::class,"completeBookingAction"]);
