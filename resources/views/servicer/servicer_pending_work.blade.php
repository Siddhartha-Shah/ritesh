...
<div class="card text-center mt-4">
  ...
  <h5>{{ $booking->booking_id }}</h5>
    ...
    <a href={{ url('/completeBookingAction', [$booking->booking_id]) }} class="btn btn-primary">Completed</a>
    <a href={{ url('/reject/'. $booking->booking_id )}} class="btn btn-danger">Cancel</a>
@endforeach
