    ...
    <body>
        <div class="main_container">
            <div class="child">
                ...
                <form method="POST" action="/servicer/login">
                    @csrf
                <div style="width:90%">
                    <p style="color:grey;margin-top:-5px;">Email <span style="color:red">*</span></p>
                    <input name="provider_email" type="text" placeholder="Enter Email" style="margin-top:-15px"/>
                </div>
                ...
                <div style="width:90%">
                    ...
                    <input name="provider_password" type="password" placeholder="Enter Password" style="margin-top:-15px"/>
                    
                </div>
                <button onclick="submit" value="submit">Login</button>
                
                    <p>Don't have an account?<span style="color:blue">
                    <a href="http://127.0.0.1:8000/serviceform" method="post"> Sign up</a>
                </span></p>
                    </form>
