        ...
        <div class="main_container">
            <div class="child">
                ...
                <div style="width:90%">
                    ...
                    <input name="customer_email" type="text" placeholder="Enter Email" style="margin-top:-15px"/>
                </div>
                ...
                <div style="width:90%">
                    ...
                    <input name="customer_password" type="password" placeholder="Enter Password" style="margin-top:-15px"/>
